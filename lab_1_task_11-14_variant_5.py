...
inputStringForTask26 = ("Натуральные числа — числа, получаемые при естественном счёте: N = { 1 , 2 , 3 , . . . }. Иногда к множеству натуральных чисел также относят ноль, то есть N = { 0 , 1 , 2 , 3 , . . . }.\n"
...
averageWeightSymbols(inputStringForTask26)

stringsMedian(inputStringForTask26)
